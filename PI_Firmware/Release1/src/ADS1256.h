...
#include "COOLER_V_LUT.h"
#include "LOAD_mA_LUT.h"
#include "LOAD_V_LUT.h"
#include "COOLER_mA_LUT.h"
#include "colors.h"
//#include "MAX31856.h"
...
void Calc_Measurement_Averages()
{
    ...
    if( pcb_temperature.num_samples > 0)
    {
        pcb_temperature.average_value = pcb_temperature.value_sum / (double)pcb_temperature.num_samples;
    }
    else
        pcb_temperature.average_value = 0;
}
